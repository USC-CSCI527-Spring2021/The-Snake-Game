...
if __name__ == "__main__":
    ...
    gpuDice = es.toGPUShape(createDice("dice.jpg"), GL_REPEAT, GL_LINEAR)
    gpuDiceBlue = es.toGPUShape(createDice("dice_blue.jpg"), GL_REPEAT, GL_LINEAR)
    ...
    while not glfw.window_should_close(window):
        ...
        lightingPipeline.drawShape(gpuDice)

        glUniformMatrix4fv(glGetUniformLocation(lightingPipeline.shaderProgram, "model"), 1, GL_TRUE, tr.translate(-0.75,0,0))
        lightingPipeline.drawShape(gpuDiceBlue)
